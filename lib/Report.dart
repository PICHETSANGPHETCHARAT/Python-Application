      ...
      body: Container(
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
                colors: <Color>[
                  Color.fromARGB(255, 245, 241, 243),
                  Color.fromARGB(255, 240, 165, 220)
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  style: TextStyle(color: Color.fromARGB(255, 213, 108, 175)),
                  decoration: InputDecoration(
                      hintText: "ค้นหาผู้ใช้",
                      hintStyle:
                          TextStyle(color: Color.fromARGB(255, 12, 4, 10)),
        ...
        DataColumn(
          label: Expanded(
            child: Text(
              'ชื่อ',
              style: TextStyle(
                  color: Color.fromARGB(255, 23, 7, 7),
                  fontFamily: "Jasmine",
                  fontSize: 16.0,
                  fontWeight: FontWeight.bold,
